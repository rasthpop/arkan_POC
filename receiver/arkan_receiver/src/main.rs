...
fn main() -> ! {
    ...
    let dio0 = pins.gpio21.into_floating_input();
    let spi= Spi::new(
        pac.SPI0,
        (
            spi_mosi,
    ...
    let _ = lora.set_mode(sx127x_lora::RadioMode::RxContinuous).unwrap();

    //let _ = lora.set_mode(RadioMode::LongRangeMode);
    //let _ = lora.set_spreading_factor(10);
    //let _ = lora.set_signal_bandwidth(72_000);
    loop {
